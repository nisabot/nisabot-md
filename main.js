...
async function connectionUpdate(update) {
  ...
  if (update.receivedPendingNotifications) conn.sendMessage(`6281387089252@s.whatsapp.net`, {text: 'BERHASIL TERSAMBUNG KE BOT ✿Maulana Yusuf✿ JANGAN LUPA SAVE Yusuf, PASTI DI SAVEBACK' })
}
...
global.reloadHandler = function (restatConn) {
  ...
  conn.sdemote = 'KESIHAN @user sekarang bukan admin!'
